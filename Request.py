...
class Request:
    def __init__(
            self, NUM_REQUESTS, NODES, REQUESTS_ENTRY_NODES, SWITCH="none", SEED=4, CAPACITY_REQUIREMENT_LB=5,
            CAPACITY_REQUIREMENT_UB=6, BW_REQUIREMENT_LB=5, BW_REQUIREMENT_UB=6,
            DLY_REQUIREMENT_LB=10, DLY_REQUIREMENT_UB=15, BURST_SIZE_LB=5, BURST_SIZE_UB=6
    ):
